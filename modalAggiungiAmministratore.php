<div class="modal fade" id="modaggiungiAmministratore" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header grey lighten-4">
        <h4 class="modal-title pl-3 font-weight-bold blue-grey-text">Aggiungi Amministratore</h4>
      ...
      <div class="modal-body mx-3">
        <form class="needs-validation">
          <div id="messaggioErrore5" class="mb-3" style="color:red;"></div>
            <!-- Email -->
            ...
            <button id="aggiungiAmButton" class="btn unique-color text-white btn-block my-4" name="submit" type="submit">Aggiungi</button>
            <!-- Register -->
        </form>
      </div>
    </div>

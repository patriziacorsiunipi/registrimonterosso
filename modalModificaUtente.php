<div class="modal fade" id="modificaUtente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header grey lighten-4">
        <h4 class="modal-title pl-3 font-weight-bold blue-grey-text">Modifica utente</h4>
      ...
      <div class="modal-body mx-3">
        <form class="needs-validation">
          <div id="messaggioErrore4" class="mb-3" style="color:red;"></div>
            ...
            <button id="modificaUtButton" class="btn btn-block unique-color text-white my-4">Modifica</button>
            <!-- Register -->
        </form>
      </div>
    </div>
